...
function CandidateDashboard() {
  ...
  function getTaskRequiredAbilities(task) {
    ...
    if (
      typeof task.requiredAbilities === "string" &&
      task.requiredAbilities.trim() !== ""
    ) {
    ...
    if (text.includes("package") || text.includes("label") || text.includes("wrap")) {
      inferred.push(
        "Can package finished products",
        "Can handle lightweight materials",
        "Can use one hand"
      );
    }
    ...
    if (text.includes("clean") || text.includes("hygiene") || text.includes("sanitize")) {
      inferred.push(
        "Can follow hygiene rules",
        "Can perform light cleaning tasks",
        "Can use one hand"
      );
    }
    ...
    if (
      ...
      inferred.push(
        "Can use one hand",
        "Can perform repetitive hand movements",
        "Can handle lightweight materials",
        "Can work seated"
      );
    }
  ...
  function calculateTaskFeasibility(task) {
    ...
    if (selectedDisabilities.length === 0) {
      return {
        label: "Select disabilities first",
        score: 0,
        status: "not_calculated",
      };
    }
    ...
    requiredAbilities.forEach((ability) => {
      ...
      selectedDisabilities.forEach((disability) => {
        ...
        const isNotFeasible = rules.notFeasible.some((keyword) =>
          normalizedAbility.includes(keyword)
        );

        const isDifficult = rules.difficult.some((keyword) =>
          normalizedAbility.includes(keyword)
        );
    ...
    if (score >= 0.4) {
      return {
        label: "Feasible with assistance",
        score: percentage,
        status: "assistance",
      };
    }
  ...
  function getFeasibilityBadgeStyle(status) {
    if (status === "feasible") {
      return { ...styles.feasibilityBadge, background: "#dcfce7", color: "#166534" };
    }

    if (status === "assistance") {
      return { ...styles.feasibilityBadge, background: "#fef3c7", color: "#92400e" };
    }

    if (status === "not_feasible") {
      return { ...styles.feasibilityBadge, background: "#fee2e2", color: "#991b1b" };
    }
  ...
  function getStatusBadgeStyle(status) {
    if (status === "accepted") {
      return { ...styles.applicationStatusBadge, background: "#ecfdf3", color: "#047857" };
    }

    if (status === "rejected") {
      return { ...styles.applicationStatusBadge, background: "#fef2f2", color: "#b91c1c" };
    }

    if (status === "in_review") {
      return { ...styles.applicationStatusBadge, background: "#eef2ff", color: "#312e81" };
    }
      ...
      <header style={styles.header}>
        <div>
          ...
          <p style={styles.headerSubtitle}>
            Hello, {candidateName}! Here&apos;s what&apos;s happening with your
            applications.
          </p>
        </div>
          ...
          <section style={styles.card}>
            {!selectedJob ? (
              <>
                ...
                <p style={styles.text}>
                  Browse posted jobs and click a card to view full details.
                </p>
                ...
                <div style={styles.jobDetailsHeader}>
                  ...
                  <div>
                    ...
                    <button
                      ...
                      onClick={() => openCompanyProfile(selectedJob)}
                    >
                ...
                <div style={styles.applicationBox}>
                  ...
                  <label style={styles.uploadLabel}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setApplicationDocument(e.target.files?.[0] || null)
                      }
                    />
                  </label>
                  ...
                  <label style={styles.uploadLabel}>
                    ...
                    {selectedJob.coverLetterRequired ? "*" : ""}
                    <input
                      type="file"
                      accept=".pdf,.doc,.docx"
                      style={styles.fileInput}
                      ...
                      onChange={(e) =>
                        setRecommendationLetter(e.target.files?.[0] || null)
                      }
                    />
                  </label>
            ...
            <div style={styles.applicationsHeader}>
              <div style={styles.applicationsHeaderLeft}>
                ...
                <div>
                  ...
                  <p style={styles.applicationsSubtitle}>
              ...
              {filteredApplications.map((application) => (
                <div key={application.id} style={styles.applicationCard}>
                  ...
                  <div style={styles.applicationInfo}>
                    <h3 style={styles.applicationJobTitle}>
      ...
      {selectedCompany && (
        <div style={styles.companyOverlay}>
          <div style={styles.companyModal}>
            <button
              type="button"
              style={styles.companyCloseButton}
            ...
            <div style={styles.companyTabs}>
              <button
                type="button"
                style={{
                  ...styles.companyTabButton,
                  ...(companyModalTab === "PROFILE" ? styles.companyTabActive : {}),
                }}
              ...
              <button
                ...
                style={{
                  ...styles.companyTabButton,
                  ...(companyModalTab === "JOBS" ? styles.companyTabActive : {}),
                }}
            ...
            {companyModalTab === "PROFILE" && (
              <div style={styles.companyProfileContent}>
                ...
                <div style={styles.companyInfoBox}>
                  ...
                  <p style={styles.companyInfoText}>
                    {selectedCompanyProfile.accessibilityStatement ||
                      "No accessibility statement has been added yet."}
                  </p>
                </div>
                ...
                <div style={styles.companyMiniGrid}>
                  <div style={styles.companyMiniBox}>
                    ...
                    <span>
                      {selectedCompanyProfile.location ||
                        selectedCompany.location ||
                        "Not specified"}
                    </span>
                  </div>
                  ...
                  <div style={styles.companyMiniBox}>
                    ...
                    {selectedCompanyProfile.website ? (
                      <a
                        href={
                          selectedCompanyProfile.website.startsWith("http")
                            ? selectedCompanyProfile.website
                            : `https://${selectedCompanyProfile.website}`
                        }
                        target="_blank"
                        rel="noreferrer"
            ...
            {companyModalTab === "JOBS" && (
              <div style={styles.companyJobsList}>
                {companyJobs.length === 0 && (
                  <div style={styles.emptyJobsBox}>
                    No open jobs are currently available for this company.
                  </div>
                )}
                ...
                {companyJobs.map((job) => (
                  <div key={job.id} style={styles.companyJobCard}>
                    ...
                    <button
                      type="button"
                      style={styles.companyApplyButton}
...
const styles = {
  ...
  applicationsShell: {
    ...
    boxShadow: "0 18px 45px rgba(15, 23, 42, 0.075)",
  },
  applicationsHeader: {
    display: "flex",
    justifyContent: "space-between",
